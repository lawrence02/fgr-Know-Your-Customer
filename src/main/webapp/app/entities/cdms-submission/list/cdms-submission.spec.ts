...
import { sampleWithRequiredData } from '../cdms-submission.test-samples';
import { CdmsSubmissionService } from '../service/cdms-submission.service';

import { CdmsSubmission } from './cdms-submission';

describe('CdmsSubmission Management Component', () => {
  let comp: CdmsSubmission;
  let fixture: ComponentFixture<CdmsSubmission>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CdmsSubmission);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.cdmsSubmissions()[0]).toEqual(expect.objectContaining({ id: 7713 }));
  });

  describe('trackId', () => {
    it('should forward to cdmsSubmissionService', () => {
      const entity = { id: 7713 };
      jest.spyOn(service, 'getCdmsSubmissionIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCdmsSubmissionIdentifier).toHaveBeenCalledWith(entity);
