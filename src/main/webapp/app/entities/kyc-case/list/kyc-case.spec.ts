...
import { sampleWithRequiredData } from '../kyc-case.test-samples';
import { KycCaseService } from '../service/kyc-case.service';

import { KycCase } from './kyc-case';

describe('KycCase Management Component', () => {
  let comp: KycCase;
  let fixture: ComponentFixture<KycCase>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(KycCase);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.kycCases()[0]).toEqual(expect.objectContaining({ id: 1342 }));
  });

  describe('trackId', () => {
    it('should forward to kycCaseService', () => {
      const entity = { id: 1342 };
      jest.spyOn(service, 'getKycCaseIdentifier');
      const id = comp.trackId(entity);
      expect(service.getKycCaseIdentifier).toHaveBeenCalledWith(entity);
